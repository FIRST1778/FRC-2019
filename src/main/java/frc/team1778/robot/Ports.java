...
public class Ports {
  ...
  public static final int LEFT_SHIFTER_FORWARD = 2;
  public static final int LEFT_SHIFTER_REVERSE = 5;
  public static final int RIGHT_SHIFTER_FORWARD = 1;
  public static final int RIGHT_SHIFTER_REVERSE = 6;
