...
public class FreezyPath {
	...
	private static Trajectory fl, fr, bl, br;
	...
	private static void setupFollowers(Trajectory trajectory) {
		SwerveModifier modifier = new SwerveModifier(trajectory).modify(WHEELBASE_WIDTH_INCHES, 
																		WHEELBASE_DEPTH_INCHES, 
		...
		encoderFollower_FL.configureEncoder(0, HardwareIDs.ENCODER_PULSES_PER_REV, HardwareIDs.WHEEL_DIAMETER_INCHES);
		encoderFollower_FR.configureEncoder(0, HardwareIDs.ENCODER_PULSES_PER_REV, HardwareIDs.WHEEL_DIAMETER_INCHES);
		encoderFollower_BL.configureEncoder(0, HardwareIDs.ENCODER_PULSES_PER_REV, HardwareIDs.WHEEL_DIAMETER_INCHES);
		encoderFollower_BR.configureEncoder(0, HardwareIDs.ENCODER_PULSES_PER_REV, HardwareIDs.WHEEL_DIAMETER_INCHES);
	...
	public static void update() 
	{
        ...
        ChillySwerve.directDrive(encoderFollower_FL, encoderFollower_FR, encoderFollower_BL, encoderFollower_BR);	
	}
}
